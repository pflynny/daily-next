...
export const ENTITIES: Record<StateKey, EntityConfig> = {
  ...
  collectionItems: {
    ...
    toRow: (i: CollectionItem) => ({
      ...
      notes: i.notes,
      pick: i.pick,
      started_on: i.startedOn,
      happened_on: i.happenedOn,
    ...
    fromRow: (r): CollectionItem => ({
      ...
      notes: str(r.notes),
      pick: bool(r.pick),
      startedOn: r.started_on ? str(r.started_on) : null,
      happenedOn: r.happened_on ? str(r.happened_on) : null,
  ...
  memoryMedia: {
    ...
    fromRow: (r): MemoryMedia => ({
      ...
      url: str(r.url),
      key: str(r.key),
      thumbKey: r.thumb_key ? str(r.thumb_key) : null,
      webKey: r.web_key ? str(r.web_key) : null,
      width: r.width ?? null,
